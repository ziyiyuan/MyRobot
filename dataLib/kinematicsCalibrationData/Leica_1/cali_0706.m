...
% nominal data
%-----------------------------------------------------
nom.joints=load('CAL1.txt')*pi/180; % six joint angles
...
nom.baseInLeica.pos = [-466.6165	521.8351	106.8143]'/1000;
nom.baseInLeica.rpy = [10.6171	1.1575	0.3724]'*pi/180;  %rpy rz*ry*rx
nom.toolPosInBase = [-13.2879	 -12.6072	39.0924]'/1000';
% nom.toolInFlange.rpy = [-90.0002	 0	90]' *pi/180; // 计算位置，不开率末端姿态；
...
mesuredData=load('mesurements1.txt')/1000;
%-----------------------------------------------------
